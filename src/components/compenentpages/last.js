    ...
    <div className="bg-[#fce4e1] p-5">
      <form onSubmit={handleSubmit(onSubmit)} className=" ">
        ...
        <div className=" ">
          ...
          <div className="sm:flex justify-between items-center bg-white border-gray-400 border ">
            <div className=" p-5 ">
            ...
            <div className="flex items-center justify-between w-28  sm:mr-10  ml-10 ">
              <div className=" w-6 h-6  ">
                <svg
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                    ...
                    <FormControlLabel
                      ...
                      control={
                        <Checkbox
                          ...
                          // value={category.id}
                          checked={category.includes(category.value)}
